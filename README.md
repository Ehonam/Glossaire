...
Installation du logiciel Laragon en complément de Visual Studio Code comme éditeur de code. On peut aussi utiliser XAMPP.
2.	Qu’est-ce qu’un algorithme ?
Un programme qui s'exécute lorsque certaines conditions prédéfinies sont remplies.
3.	Qu’est-ce qu’une variable ? Par quel symbole est préfixée une variable en PHP ?
Un paramètre ou une donnée qui peut changer de valeur. En PHP c'est le symbole $ qui permet de l'identifier.
4.	Qu’est-ce que la portée d’une variable ?
Ensemble des endroits du programme où existe la variable
